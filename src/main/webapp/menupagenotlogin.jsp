...
<style type="text/css">
  ...
  .container1 { max-width:1300px; padding-left:30px; padding-right:30px; margin: auto;}
      ...
      <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
        <div class="logo">
          <a href="homepage.html">
            <img src="assets/images/logo.svg" alt="e-Medan Food Ordering Website" title="e-Medan Food Ordering Website" />
          </a>
        </div>
      </div>
...
<div id="page-content">
  ...
  <div class="page section-header text-center">
    <div class="page-title">
      <div class="wrapper"><h1 class="page-width">Menu Page</h1></div>
    </div>
  </div>
  <div class="container2" style="position: relative; right: -80px;">
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
        <div id="accordionExample">
          <h2 class="title h2">Gerai A</h2>
          <hr class="new4" style="width: 90%;">
          <div class="bord1">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/nasi goreng pataya.jpg" alt="nasi pataya" width="150" height="120" />
              ...
              <h2>RM6.00</h2> <button class="button1" style="background-color: rgb(111, 158, 40);">Add to Cart</button>
            </td>
          </div>
          <div class="bord2">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/mee_goreng.jpg" alt="mee goreng" width="150" height="120" />
              <div class="list-view-item__title">
                Mee Goreng
              </div>
              <div class="cart__meta-text">
              ...
              <h2>RM3.50</h2> <button class="button1" style="background-color: rgb(111, 158, 40);">Add to Cart</button>
            </td>
          </div>
          <div class="bord3">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/nasi ayam.jpg" alt="nasi ayam" width="150" height="120" />
              <div class="list-view-item__title">
                Nasi Ayam
              </div>
              <div class="cart__meta-text">
              ...
              <h2>RM4.50</h2> <button class="button1" style="background-color: rgb(111, 158, 40);">Add to Cart</button>
            </td>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
        <div id="accordionExample">
          <div class="bord1">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/lontong.jpg" alt="lontong" width="150" height="120" />
              <div class="list-view-item__title">
                Lontong
              </div>
              <div class="cart__meta-text">
              ...
              <h2>RM3.00</h2> <button class="button1" style="background-color: rgb(111, 158, 40);">Add to Cart</button>
            </td>
          </div>
          <div class="bord2">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/maggi goreng.jpg" alt="maggi goreng" width="150" height="120" />
              <div class="list-view-item__title">
                Maggi Goreng
              </div>
              <div class="cart__meta-text">
          ...
          <div class="bord3">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/bakso.jpg" alt="bakso" width="150" height="120" />
              <div class="list-view-item__title">
                Bakso
              </div>
              <div class="cart__meta-text">
              ...
              <h2>RM5.00</h2> <button class="button1" style="background-color: rgb(111, 158, 40);">Add to Cart</button>
            </td>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
        <div id="accordionExample">
          <div class="bord1">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/nasi lemak ayam.jpg" alt="nasi lemak ayam" width="150" height="120" />
              <div class="list-view-item__title">
                Nasi Lemak Ayam
              </div>
              <div class="cart__meta-text">
              ...
              <h2>RM5.50</h2> <button class="button1" style="background-color: rgb(111, 158, 40);">Add to Cart</button>
            </td>
          </div>
          <div class="bord2">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/nasi lemak biasa.jpg" alt="nasi lemak biasa" width="150" height="120" />
              <div class="list-view-item__title">
                Nasi Lemak Biasa
              </div>
              <div class="cart__meta-text">
          ...
          <div class="bord3">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/nasi goreng kampung.jpg" alt="nasi goreng kampung" width="150" height="120" />
              <div class="list-view-item__title">
                Nasi Goreng Kampung
              </div>
              <div class="cart__meta-text">
    ...
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
        <div id="accordionExample">
          <div class="bord1">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/nasi kerabu.jpg" alt="nasi kerabu" width="150" height="120" />
              <div class="list-view-item__title">
                Nasi Kerabu
              </div>
              <div class="cart__meta-text">
          ...
          <div class="bord2">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/nasi dagang kari ikan.webp" alt="nasi dagang kari ikan" width="150" height="120" />
              <div class="list-view-item__title">
              ...
              <h2>RM7.00</h2> <button class="button1" style="background-color: rgb(111, 158, 40);">Add to Cart</button>
            </td>
          </div>
          <div class="bord3">
            <td class="cart__meta small--text-left cart-flex-item">
              <img src="${pageContext.request.contextPath}/assets/images/kuey teow kungfu.jpg" alt="kuey teow kungfu"" width="150" height="120" />
              <div class="list-view-item__title">
                Kuey Teow Kungfu
              </div>
              <div class="cart__meta-text">
