        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    <a href= "<%=request.getContextPath()%>/loginStudent.jsp"><button class="btn btn-light">Student</button></a><br><br>
                    <a href="<%=request.getContextPath()%>/loginCafeWorker.jsp"><button class="btn btn-light">Cafe Worker</button></a>
                </div>
                <div class="signin-image">
                    <figure><img src="assets/images/login@4x.png" alt="sing up image"></figure>
                </div>
            </div>
        </div>
