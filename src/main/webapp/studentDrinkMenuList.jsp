...
<head>
    ...
    <title>Menu Page &ndash; Drink</title>
    ...
    <div id="page-content">
        ...
        <div class="collection-header">
            <div class="collection-hero">
                ...
                <div class="collection-hero__title-wrapper"><h1 class="collection-hero__title page-width">Drink Menu Page</h1></div>
            </div>
        </div>
                                    ...
                                    <div class="col-4 col-md-4 col-lg-4 text-center filters-toolbar__item filters-toolbar__item--count d-flex justify-content-center align-items-center">
                                        <%
                                            try{
                                                ...
                                                String sql ="SELECT COUNT (\"MENUID\") FROM public.menu WHERE \"MENUTYPE\" = 'D';";
                                ...
                                <%
                                    try{
                                        ...
                                        String sql ="SELECT \"MENUID\", \"MENUNAME\", \"MENUDESC\", \"MENUTPRICE\", \"MENUTYPE\", \"fileName\", \"savePath\"\n" +
                                                "\tFROM public.menu WHERE \"MENUTYPE\" = 'D';";
                                        resultSet = statement.executeQuery(sql);
                                    ...
                                    <div class="list-product list-view-item">
                                        <div class="list-view-item__image-column">
                                            <div class="list-view-item__image-wrapper">
                                                <!-- Image -->
                                                <a href="#"><image src="images/<%=resultSet.getString("fileName")%>" width="250" height="250"/></a>
                                                <!-- End Image -->
                                            </div>
                                        </div>
