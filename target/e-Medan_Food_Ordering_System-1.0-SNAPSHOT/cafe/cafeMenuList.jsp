        ...
        <div class="container">
            <div class="text-center">
                ...
                <div class="container text-left">
                    <a href="AddMenu.jsp" class="btn btn--sm" style="background-color: #5cb85c;">ADD MENU </a>
                </div>
...
<%--                            <button type="button" id="<%=rs.getString("MENUID")%>" style="background-color: #5cb85c;" class="upd btn btn--sm">Update</button>--%>
                            <a  href="updateMenu.jsp?id=<%=rs.getString("MENUID")%>" style="background-color: #5cb85c;" class="btn btn--sm">Update</a>
...
<%--                    <button type="button" id="<%=rs.getString("MENUID")%>" class="btn btn-sm btn-danger">Delete</button>--%>
<%--                </td>--%>
<%--            </tr>--%>
