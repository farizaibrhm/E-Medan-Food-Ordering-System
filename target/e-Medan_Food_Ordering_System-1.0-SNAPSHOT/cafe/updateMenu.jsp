...
<div class="pageWrapper">
    ...
    <div id="page-content">
        ...
        <form action="#" method="post" style="position: relative;top: 80px;left: 25%;">
            <h2 style="position:relative; left: 18%;">UPDATE MENU DETAILS</h2>
            <table class="t4">
                <tr>
                    <td>MENU ID</td>
                    <td><input type="textarea" name="menuId"   disabled /></td>
                </tr>
                <tr>
                    <td>MENU NAME</td>
                ...
                <tr>
                    <td colspan="2">
                        <center><input class="butt" type="submit" value="Update" onClick="return confirm('Are you sure?')"></center>
                    </td>
                </tr>
            </table>
        </form>
