...
<head>
    ...
    <!-- Main css -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/styleregister.css">
</head>
<body>
<!--Top Header-->
        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    <a href="./student/loginStudent.jsp"><button class="btn btn-light">Student</button></a><br><br>
                    <a href="./cafe/loginCafeWorker.jsp"><button class="btn btn-light">Cafe Worker</button></a>
                </div>
                <div class="signin-image">
                    <figure><img src="<%=application.getContextPath() %>/assets/images/signin-image.jpg" alt="sing up image"></figure>
                </div>
            </div>
        </div>
...
<!-- JS -->
<script src="<%=application.getContextPath() %>/assets/vendor/jquery/jquery.min.js"></script>
<script src="<%=application.getContextPath() %>/assets/js/mainform.js"></script>
