...
<head>
    ...
    <title>Total Sales Report &ndash; e-Medan Food Ordering System</title>
    ...
    <div id="page-content">
        ...
        <div class="page section-header text-center">
            <div class="page-title">
                <div class="wrapper"><h1 class="page-width">Total Sales Report</h1></div>
            </div>
        </div>
        <div class="container">
            <div class="row" >
                ...
                <div class="dropdown " style="padding : 10px" >
                    ...
                    <button style="background-color:slategray; border-radius: 25px; font-size: small; " onclick="myFunction()" class="dropbtn">Month</button>
                    ...
                    <button style = "background-color: slategray; border-radius: 20px; font-size: small;"onclick="myFunctions()" class="dropbtn">Year</button>
                    <div id="myDropdowns" class="dropdown-content">
                        <a href="#">2021</a>
                        <a href="#">2022</a>
                    </div>
                    <button class="btn-secondary" style="cursor: pointer;">Go</button>
