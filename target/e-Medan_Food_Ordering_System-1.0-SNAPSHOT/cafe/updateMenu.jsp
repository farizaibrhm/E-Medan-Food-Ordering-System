...
<%@ page import="com.example.emedan_food_ordering_system.MenuDAO" %>
<html>
<head>
    <title>Title</title>
</head>
...
<div class="testbox">
    <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/UpdateMenuServlet">
        <div class="banner">
            <h1>UPDATE MENU </h1>
        </div>
