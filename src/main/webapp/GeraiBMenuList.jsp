...
<head>
    ...
    <title>Menu Page &ndash; Gerai B</title>
                ...
                <div id="page-content">
                    ...
                    <div class="collection-header">
                        <div class="collection-hero">
                            ...
                            <div class="collection-hero__title-wrapper"><h1 class="collection-hero__title page-width">Gerai B</h1></div>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4 col-md-4 col-lg-4 text-center filters-toolbar__item filters-toolbar__item--count d-flex justify-content-center align-items-center">
                                                    <%
                                                        ...
                                                        String sql ="SELECT COUNT (\"m\".\"MENUID\") FROM public.menu \"m\", public.cafeworker \"c\" WHERE \"m\".\"CWORKID\" = \"c\".\"CWORKID\" AND \"c\".\"CWORKSTALLNAME\" = 'Gerai B';\n";
                                    ...
                                    <div class="grid-products grid--view-items">
                                        <div class="row">
                                            <%
                                                ...
                                                ResultSet resultSet2 = statement2.executeQuery("SELECT * FROM public.menu \"m\", public.cafeworker \"c\" WHERE \"m\".\"CWORKID\" = \"c\".\"CWORKID\" AND \"c\".\"CWORKSTALLNAME\" = 'Gerai B';\n");
