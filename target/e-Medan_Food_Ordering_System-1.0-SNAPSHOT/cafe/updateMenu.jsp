        ...
        <div id="MainContent" class="main-content" role="main">
            ...
            <div class="bredcrumbWrap">
                <div class="container-fluid breadcrumbs">
                    <a href="cafeMenuList.jsp" title="Back to the home page">Menu List</a><span aria-hidden="true">›</span><span>Edit Menu</span>
                </div>
            </div>
            <!--End Breadcrumb-->
...
//                    ResultSet rs = st.executeQuery(sql);
            ...
            <div class="testbox">
                <form method="post" enctype="multipart/form-data" action="update.jsp">
                    ...
                    <input type="hidden" name="MENUID" value="<%=rs.getString("MENUID") %>">

                    <div class="item">
                        <p>MENU NAME</p>
                        <input type="text" name="MENUNAME" value="<%=rs.getString("MENUNAME") %>"/>
                    </div>
                    <div class="item">
                        <p>MENU DESCRIPTION</p>
                        <input type="text" name="MENUDESC" value="<%=rs.getString("MENUDESC") %>"/>
                    </div>
                    <div class="item">
                        <p>MENU PRICE (RM)</p>
                        <input type="text" name="MENUTPRICE" value="<%=rs.getString("MENUTPRICE") %>"/>
                    </div>
                    <div class="item">
                        <p>MENU TYPE</p>
                        <select id="menuType" name="MENUTYPE" value="<%=rs.getString("MENUTYPE") %>">
...
<%--                    <input type="text" disabled="disabled" name="filePath" value="<%=rs.getString("filePath") %>">--%>
<%--                    <input type="text"  disabled="disabled" name="savePath" value="<%=rs.getString("savePath") %>">--%>
